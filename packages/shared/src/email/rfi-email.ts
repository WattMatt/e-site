...
<body><div class="card">${content}<div class="footer">E-Site Construction Management · <a href="${siteUrl}" style="color:#3B82F6">${siteUrl.replace(/^https?:\/\//, '')}</a></div></div></body></html>`
}
