...
BEGIN
  ...
  FOR r IN SELECT * FROM (VALUES
      -- rfi: 'creator', amended by 00202 C' (improvement 4). This file asserts
      -- the registry as of the LATEST migration: green with WITH_EXTRA=<00202>
      -- stacked, red against production until 00202 applies.
