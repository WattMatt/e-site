...
> `00199:834` runs `UPDATE projects.work_item_types SET gatekeeper_rule =
> 'creator' WHERE key = 'rfi'`, and `project_rfi` calls
> `resolve_work_item_gatekeeper(r.project_id, r.raised_by)` in **both** arms
> (`00199:975` on insert, `00199:1070` on update); measured
...
> falls back to the project PM** (`00199:968-974`). Any sentence anywhere in this file
