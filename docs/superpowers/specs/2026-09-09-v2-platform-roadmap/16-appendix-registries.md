...
|---|---|---|
| **Q1** | `work_items`, `work_item_types`, `work_item_events`, `work_item_watchers`, `activity`, `public_holidays`, `calendar_years`, `working_days_between()`, `project_had_activity()`, `add_working_days()`, `push_past_builders_shutdown()`, `org_owner()`, `resolve_project_pm()`, `resolve_triage_owner()`, `resolve_work_item_assignee()`, `user_can_read_work_item()`, `user_can_write_work_item()` | `projects` |
