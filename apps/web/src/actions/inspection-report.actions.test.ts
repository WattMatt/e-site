...
const h = vi.hoisted(() => ({
  ...
  inspProjectId: '22222222-2222-2222-2222-222222222222',
}))
...
vi.mock('@/lib/supabase/server', () => ({
  createClient: async () => ({
    ...
    schema: () => ({ from: () => ({ select: () => ({ eq: () => ({ maybeSingle: async () => ({ data: { id: 'insp-1', project_id: h.inspProjectId } }) }) }) }) }),
  }),
}))
...
describe('regenerateInspectionReportAction', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    h.inspProjectId = '22222222-2222-2222-2222-222222222222'
  })
  ...
  it('rejects an inspection that does not belong to this project', async () => {
    h.inspProjectId = '33333333-3333-3333-3333-333333333333'
    const res = await regenerateInspectionReportAction('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222')
