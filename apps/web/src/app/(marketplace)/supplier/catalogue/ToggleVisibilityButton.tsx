  ...
  return (
    <button
      ...
      style={{
        ...
        padding: '5px 10px',
        borderRadius: 4,
        background: currentVisible ? 'var(--c-green-dim)' : 'var(--c-elevated)',
        color: currentVisible ? 'var(--c-green)' : 'var(--c-text-dim)',
        border: `1px solid ${currentVisible ? 'var(--c-green)' : 'var(--c-border)'}`,
