-- =============================================================================
-- Migration 00081 — drop legacy cable-schedule board structures
-- =============================================================================
-- Background:
...
BEGIN
    ...
    IF _dangling > 0 THEN
        RAISE EXCEPTION
            '00081 aborted: % supply row(s) still reference an RMU/MINISUB '
...
DO $$
BEGIN
    RAISE NOTICE '00081 complete: legacy cable_schedule.boards dropped, '
