...
-- jbcc_clauses
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('Clause Ref.', 'Contract', 'Edition', 'Topic', 'Description', 'Practical Use', 'Time-Bar (WD/CD)', 'Triggering Event', 'Linked Notice / Letter', 'Consequence of Failure', 0) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('1.0', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Contractor''s Obligations', 'Contractor must execute and complete the works as specified and notify the Principal Agent of any discrepancies in the contract documents.', 'Defines the primary scope of work; obliges the contractor to flag errors in drawings or specifications to preserve rights.', 'Immediate', 'Discovery of discrepancy in documents', 'Notice of Discrepancy / Request for Information', 'Contractor accepts the document as correct; loses right to claim extras arising from the discrepancy.', 1) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('2.0', 'JBCC PBA', 'Ed 6', 'Statutory Obligations', 'Parties must comply with all applicable laws, regulations, by-laws, OHS requirements and obtain necessary permits and approvals.', 'Allocates responsibility for statutory compliance to prevent site shut-down or regulatory penalty.', 'Project duration', 'Non-compliance discovered', 'Notice to Rectify Statutory Non-compliance', 'Party in breach bears all consequential cost; possible termination for material breach.', 2) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('6.3', 'JBCC PBA', 'Ed 6', 'Declaration of Interest', 'Principal Agent or agent must declare any interest in the works beyond professional services.', 'Ensures transparency and prevents conflicts of interest in certification and instructions.', 'Immediate on becoming aware', 'Discovery of conflict of interest', 'Notice to Declare Interest', 'Risk of agent decisions being set aside; reputational damage.', 3) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('6.4', 'JBCC PBA', 'Ed 6', 'Principal Agent Non-Performance', 'Contractor may notify the Employer of the Principal Agent''s failure to perform duties and require the default to be rectified.', 'Three-step disciplined process (rectify > intend to suspend > suspend) to compel agent compliance or replacement.', '5 + 5 WD', 'Agent fails to issue instruction, certificate or determination', 'Notice to Principal Agent to Rectify Default', 'Contractor cannot proceed to suspension or claim associated expense and loss.', 4) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('10.3', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Proof of Insurance', 'Party responsible for insurance must provide proof of policy or renewal to the other party.', 'Confirms financial backing for works, public liability and SASRIA cover before site access.', '10 WD', 'Date insurance is required to be in place', 'Notice of Objection to Proof of Insurance', 'Other party may take out the insurance and recover the premium plus 15%.', 5) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('11.1', 'JBCC PBA', 'Ed 6', 'Construction Securities', 'Contractor must provide a Variable or Fixed Construction Guarantee within 15 working days of acceptance.', 'Provides the Employer with financial recourse in case of contractor default; permits waiver of lien.', '15 WD', 'Acceptance of tender', 'Notice of Submission of Construction Guarantee', 'Employer may terminate or withhold first payment until security is provided.', 6) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('11.8', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Return of Securities', 'Party in possession of original security must return it on expiry or termination.', 'Closes the security loop and prevents wrongful retention of the original guarantee.', '10 WD', 'Expiry or termination event', 'Notice of Return of Security', 'Party retaining the original may be liable for the amount of the guarantee.', 7) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('11.0 (Advance)', 'JBCC PBA', 'Ed 6', 'Advance Payment Guarantee', 'Contractor provides an Advance Payment Guarantee equal to the advance payment, reducing as the advance is recouped.', 'Protects the Employer against non-performance after release of the advance.', 'Before advance is certified', 'Advance payment certified', 'Notice of Submission of Advance Payment Guarantee', 'Advance payment will not be certified.', 8) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('13.0', 'JBCC MWA', 'Ed 5.1', 'Valuation and Payment', 'Principal Agent issues monthly payment certificates valuing work executed and materials on site.', 'Establishes the cash-flow rhythm of the project; basis for non-payment, suspension and finance-charge claims.', 'Monthly', 'Issue of payment certificate', 'Notice of Non-Payment', 'Loss of right to claim mora interest or suspend works.', 9) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('13.0 (NSSA)', 'JBCC NSSA / SSA', 'Ed 6', 'Nominated & Selected Subcontractors – Payment Flow', 'Defines payment route from Employer through Contractor to subcontractor; no privity between Employer and subcontractor.', 'Sets responsibility for honouring subcontract payment certificates and the back-to-back relationship.', 'Per main contract', 'Issue of subcontract payment certificate', 'Subcontract Payment Notice', 'Subcontractor''s right of recovery defaults to main contractor only.', 10) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('14.0 / 17.1', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Contract Instructions', 'Principal Agent may issue written instructions varying design, quality, quantity or sequence of the works.', 'Mechanism for variations, defect rectification and rescoping; must be in writing to bind the contractor.', 'Within 5 WD of receipt', 'Receipt of a contract instruction (CI)', 'Notice of Constructive Change / Claim for Extras (Advance)', 'Variation may be deemed included in the contract sum.', 11) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('14.0 (PBA NSC)', 'JBCC PBA', 'Ed 6', 'Nominated Subcontractors', 'Subcontractor selected by the Employer or Principal Agent for specialist work.', 'Employer carries the risk of the nominated subcontractor''s default.', 'Per nomination instruction', 'Nomination instruction issued', 'Notice of Acceptance / Objection to Nomination', 'Forced acceptance with no recourse against the Employer for downstream defaults.', 12) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('15.0 (PBA SSC)', 'JBCC PBA', 'Ed 6', 'Selected Subcontractors', 'Subcontractor chosen from a joint list agreed between Employer and Contractor.', 'Contractor accepts performance and insolvency risk of selected subcontractor.', 'Per selection instruction', 'Selection list issued', 'Notice of Selection / Objection', 'Contractor''s objection rights lapse.', 13) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('23.0', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Revision of Practical Completion Date', 'Contractor entitled to a revised date for practical completion for listed events beyond its control.', 'Avoids penalties / liquidated damages for non-culpable delay events.', 'Per Cl 23.4.2 / 23.5', 'Occurrence of a qualifying delay event', 'Request for Extension of Time and Additional Compensation', 'Penalties continue to accrue against the contractor.', 14) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('23.4.2', 'JBCC PBA', 'Ed 6', 'Notice of Intention to Claim EOT', 'Contractor must notify the Principal Agent of a possible revision of the date for practical completion.', 'Triggers the EOT process; critical time-bar that, once missed, forfeits the claim.', '20 WD', 'Becoming aware of a delay event', 'Notice of Delay / Notice of Intention to Claim', 'Forfeiture of the EOT claim (NV Properties v Radon).', 15) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('23.5', 'JBCC PBA', 'Ed 6', 'Quantified EOT Claim', 'Contractor submits a fully quantified EOT claim with substantiation and revised programme.', 'Provides the agent with the evidence and calculation needed to certify the revised date.', '40 WD', 'End of the delay event / ability to quantify', 'Quantified EOT Claim Submission', 'Claim may be rejected as unsubstantiated and time-barred.', 16) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('17.0', 'JBCC MWA', 'Ed 5.1', 'Revision of Practical Completion (Minor Works)', 'Contractor must report the cause of delay and the days claimed at the next site meeting.', 'Less strict than PBA but still requires recorded notification; preserves the right to additional time.', 'Next site meeting', 'Occurrence of delay event', 'Site Meeting Minute / MWA EOT Notice', 'Delay event treated as culpable; penalties continue.', 17) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('24.0', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Practical Completion', 'Stage at which the works are substantially complete and may be used for the intended purpose.', 'Triggers handover, end of penalty accrual and start of the defects liability period.', 'Per inspection process', 'Contractor''s view that works are ready', 'Notice of Anticipated Practical Completion', 'Penalties continue to accrue; risk does not transfer to Employer.', 18) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('25.7 / 19.7', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Payment of Certified Amount', 'Employer must pay the amount of the payment certificate within the stipulated period.', 'Triggers the contractor''s right to mora interest and, ultimately, to suspend or terminate.', '14 CD', 'Issue of payment certificate', 'Notice of Non-Payment', 'Loss of right to mora interest if not formally claimed.', 19) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('26.5', 'JBCC PBA', 'Ed 6', 'Notice of Possible Expense and Loss', 'Contractor must notify the agent of expense and loss not provided for in the contract sum.', 'Mirrors the EOT notice; required to preserve the loss and expense claim.', '20 WD', 'Becoming aware of expense / loss event', 'Notice of Expense and Loss', 'Forfeiture of the loss and expense claim.', 20) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('26.6', 'JBCC PBA', 'Ed 6', 'Substantiated Expense and Loss Claim', 'Contractor submits the quantified and substantiated expense and loss claim.', 'Provides the agent with the basis to adjust the contract value.', '40 WD', 'Ability to quantify the loss', 'Substantiated Expense and Loss Claim', 'Claim may be rejected as unsubstantiated.', 21) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('26.9.4', 'JBCC PBA', 'Ed 6', 'Adjustment of Preliminaries & Generals', 'P&G amounts are adjusted in accordance with the method elected in the contract data.', 'Recovers time-related overhead when the completion date is revised.', 'With EOT claim', 'EOT awarded', 'P&G Adjustment Submission', 'P&G under-recovery; out-of-pocket overhead.', 22) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('28.0', 'JBCC PBA', 'Ed 6', 'Suspension by Contractor', 'Contractor may suspend the works on 10 WD notice if the Employer is in material default.', 'Lever to compel payment or remedy other material breaches without immediate termination.', '10 WD', 'Employer default (payment, insurance, possession)', 'Notice of Intention to Suspend', 'Loss of right to suspend; potential cash-flow collapse.', 23) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('19.11', 'JBCC MWA', 'Ed 5.1', 'Suspension by Contractor (Minor Works)', 'Contractor may suspend on 3 WD notice for non-payment.', 'Faster suspension lever appropriate to smaller projects.', '3 WD', 'Non-payment of certified amount', 'MWA Notice of Intent to Suspend', 'Cash-flow loss; weakens negotiating position.', 24) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('30.0', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Penalty for Late Completion', 'Contractor liable for the penalty per calendar day for late achievement of practical completion.', 'Liquidated remedy for the Employer; calibrated against the daily holding cost.', 'Per calendar day', 'Failure to achieve practical completion', 'Penalty Deduction Notification', 'Penalty deducted from payment certificates and securities.', 25) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('33.0 / 27.0', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Recovery of Expense and Loss by Employer', 'Employer may recover expense and loss resulting from contractor default, including the cost of completing the works.', 'Set-off against payment certificates and call-up of the construction guarantee.', 'Per recovery event', 'Contractor default', 'Notice of Recovery / Call on Guarantee', 'Loss of right to recover; cost borne by Employer.', 26) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('21.0', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Termination', 'Either party may terminate for material breach (non-payment, failure to give possession, insolvency, etc.).', 'Last-resort remedy; requires strict procedural compliance to avoid wrongful repudiation.', 'Per default notice clause', 'Persistent material breach', 'Notice of Termination', 'Wrongful termination = repudiation, with damages owed.', 27) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('40.0', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Dispute Resolution', 'Disputes are referred first to adjudication and thereafter to arbitration in accordance with the contract.', 'Avoids litigation; adjudicator''s decision is binding pending arbitration.', '10 WD (disagreement = dispute under MWA 22.2)', 'Issue of Notice of Disagreement', 'Notice of Dispute / Referral to Adjudication', 'Dispute may be deemed accepted or time-barred.', 28) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('Differing Site Conditions', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Differing Site Conditions', 'Conditions encountered on site differ materially from those indicated in the contract documents.', 'Triggers a contract instruction and adjustment of contract value and date.', 'Promptly upon discovery', 'Discovery of materially differing condition', 'Notice of Differing Site Conditions', 'Contractor bears the cost of the unforeseen condition.', 29) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('Constructive Change', 'Generic / JBCC', '—', 'Constructive Change', 'Oral, field or implied direction that changes the scope of work without a formal variation order.', 'Establishes a written record so a CI can be regularised and the cost recovered.', 'Promptly upon receipt', 'Receipt of informal direction', 'Notice of Constructive Change', 'Work treated as included in the contract sum.', 30) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('Access Delay', 'Generic / JBCC', '—', 'Access Delay', 'Site access to a specific area or piece of equipment is impeded by others.', 'Documents employer-caused delay on the critical path.', 'Promptly upon impediment', 'Loss of access to critical area', 'Notice of Access Delay', 'Idle labour and plant cost borne by the contractor.', 31) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('Force Majeure', 'JBCC PBA / MWA', 'Ed 6 / 5.1', 'Force Majeure', 'Event beyond the reasonable control of either party (e.g. war, civil commotion, declared disaster).', 'Suspends time-bound obligations; basis for EOT without loss and expense.', 'Promptly upon event', 'Occurrence of force majeure event', 'Notice of Force Majeure', 'Event treated as culpable delay; penalties accrue.', 32) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('3.2 (NSCA/SSA)', 'JBCC NSCA / SSA', 'Ed 6', 'Back-to-Back Pass-Through', 'Subcontractor''s entitlement to time and money mirrors the main contract; subcontractor must notify the contractor within the time-bar that allows the contractor to notify the Employer.', 'Protects the main contractor from being time-barred by subcontractor delay; aligns subcontract and main contract clocks.', 'Per main contract less buffer', 'Subcontractor becomes aware of event', 'Subcontractor EOT Pass-Through Notice', 'Loss of subcontractor''s right to time and money.', 33) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('6.0 (NSCA/SSA)', 'JBCC NSCA / SSA', 'Ed 6', 'Subcontract Instructions', 'Contractor issues subcontract instructions analogous to PBA Cl 17.', 'Maintains chain of command and written record between contractor and subcontractor.', 'Per subcontract', 'Issue of subcontract instruction', 'Subcontract Instruction / Acknowledgement', 'Subcontract instruction may be unenforceable.', 34) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;
INSERT INTO projects.jbcc_clauses (clause_ref, contract, edition, topic, description, practical_use, time_bar, triggering_event, linked_notice, consequence_of_failure, sort_order) VALUES ('11.0 (NSCA/SSA)', 'JBCC NSCA / SSA', 'Ed 6', 'Subcontractor Non-Compliance', 'Contractor may notify the subcontractor of default and require rectification before further action.', 'Step required before main contractor can substitute subcontractor or call security.', 'Per subcontract default clause', 'Subcontractor default', 'Non-Compliance Notice to Subcontractor', 'Risk that substitution is treated as wrongful termination.', 35) ON CONFLICT (clause_ref, contract, edition) DO NOTHING;

-- jbcc_time_bar_schedule
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('Clause', 'Time Period', 'Initiator → Recipient', 'Action / Subject', 0) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 2.5 / MWA 2.5', '1–7 CD', 'Parties / Principal Agent', 'Deemed receipt of notices (email = 1 WD; registered post = 7 CD).', 1) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 6.4 / MWA 5.4', '5 WD', 'Contractor → PA / Employer', 'Notice to rectify Principal Agent non-performance.', 2) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 5.5', '5 WD', 'Employer', 'Appoint successor agent following contractor''s rectification notice.', 3) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 10.3 / MWA 10.3', '10 WD', 'Insuring Party', 'Provide proof of insurance / renewal.', 4) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 11.1 / MWA 9.1.1', '15 WD', 'Parties', 'Submit Construction / Payment Securities.', 5) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 9.1.2', '20 WD', 'Parties', 'Provide replacement securities for EOT.', 6) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 9.1.3', '15 WD', 'Parties', 'Adjust security if contract value increases > 10%.', 7) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 11.8 / MWA 9.1.4', '10 WD', 'Parties', 'Return original security on expiry or termination.', 8) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 11.0', '15 WD', 'Contractor', 'Submit security, priced document and programme.', 9) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 14.3', '5 WD', 'Contractor', 'Deadline to proceed with a contract instruction.', 10) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 23.4.2', '20 WD', 'Contractor → PA', 'Notice of possible delay — failure = forfeit EOT claim.', 11) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 23.5', '40 WD', 'Contractor → PA', 'Submit quantified EOT claim with substantiation.', 12) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 15.4', '5 + 5 WD', 'Contractor → PA / Employer', 'Notice if no completion list issued (deemed completion).', 13) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 16.3', '5 WD', 'PA → Contractor', 'Issue updated list for final completion.', 14) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 17.4.1', '10 WD', 'PA', 'Determine revised date for practical completion.', 15) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 17.4.2', '10 WD', 'PA', 'Determine adjustment of the contract value.', 16) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 25.7 / MWA 19.7', '14 CD', 'Employer → Contractor', 'Pay the amount of the payment certificate.', 17) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 26.5', '20 WD', 'Contractor → PA', 'Notice of possible expense and loss — failure = forfeit claim.', 18) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 26.6', '40 WD', 'Contractor → PA', 'Submit substantiated expense and loss claim.', 19) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 20.4', 'Notice', 'Contractor → PA', 'Notice of possible expense and loss (MWA).', 20) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 21.2', '10 WD', 'Employer (PA) → Contractor', 'Notice of defaults to be remedied before suspension.', 21) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 21.19', '20 WD', 'PA', 'Status report following termination.', 22) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 22.2', '10 WD', 'Either Party', 'Deadline for disagreement to be deemed a dispute.', 23) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('PBA 28.0', '10 WD', 'Contractor → Employer', 'Notice of intention to suspend the works.', 24) ON CONFLICT (clause, sort_order) DO NOTHING;
INSERT INTO projects.jbcc_time_bar_schedule (clause, time_period, parties, action, sort_order) VALUES ('MWA 19.11', '3 WD', 'Contractor → Employer', 'Notice of intention to suspend (Minor Works).', 25) ON CONFLICT (clause, sort_order) DO NOTHING;
