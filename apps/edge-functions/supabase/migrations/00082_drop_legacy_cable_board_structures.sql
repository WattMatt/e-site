-- =============================================================================
-- Migration 00082 — drop legacy cable-schedule board structures
-- =============================================================================
-- Background:
...
BEGIN
    ...
    IF _dangling > 0 THEN
        RAISE EXCEPTION
            '00082 aborted: % supply row(s) still reference an RMU/MINISUB '
...
DO $$
BEGIN
    RAISE NOTICE '00082 complete: legacy cable_schedule.boards dropped, '
