// SANS 10142-1:2020 validation rules — COC deliverable type.
// Source: INSPECTION_TEMPLATES_CATALOGUE.md Part 4.
//
// Applies to templates with deliverable_type = 'coc':
//   electrical-meter-nrs057, lv-coc, lv-db-inspection,
//   lv-emb-inspection, lv-line-shop-board-audit
//
...
// ----------------------------------------------------------------------------
// The 8 COC rules (catalogue Part 4 — in declared order)
// ----------------------------------------------------------------------------

const COC_RULES: ((ctx: RuleContext) => RuleResult)[] = [
...
/** Run all 8 SANS 10142-1 COC rules against the given context. */
export const runCocRules: RuleRunner = (ctx) => COC_RULES.map((rule) => rule(ctx))
