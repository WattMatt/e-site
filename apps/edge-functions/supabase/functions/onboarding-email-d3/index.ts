/**
 * Edge Function: onboarding-email-d3 — daily cron.
 * Sends the Day-3 "invite a field worker" email. See d1 for shape notes.
 */
...
import { onboardingD3 } from '../_shared/email-templates/onboarding-d3.ts'
